...
const EditTextModal = ({ textProperties, setTextProperties }) => {
  return (
    <>
      ...
      <DialogContent>
        ...
        />
        <DialogContentText>
        Position (x and y from top left corner %)
        </DialogContentText>
        <Typography id="discrete-slider" gutterBottom>
        x (from left)
        </Typography>
        <Slider
          ...
          min={0}
          max={100}
          value={textProperties.positionX}
          onChange={(e) => setTextProperties({ ...textProperties, positionX: e.target.value })}
        ...
        <Slider
          ...
          min={0}
          max={100}
          value={textProperties.positionY}
          onChange={(e) => setTextProperties({ ...textProperties, positionY: e.target.value })}
